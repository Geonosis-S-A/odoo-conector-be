...
async def sync_timeoff_requests(
    ...
    try:
        ...
        try:
            ...
            logger.error(
                f"Error crítico en sincronización de nuevas solicitudes: {str(e)}",
                exc_info=True,
            )
        ...
        try:
            ...
            logger.error(
                f"Error crítico en sincronización de estados: {str(e)}", exc_info=True
            )
