...
class TestObtenerTareasUseCase:
    ...
    def test_execute_by_user_returns_user_tasks(
        self, use_case, mock_gateway, mock_odoo_employee_gateway
    ):
        # Arrange
        test_tasks = [
            Task(
        ...
        mock_odoo_employee_gateway.exists_by_id.return_value = True
        test_user_id = 5
        ...
        # Assert
        mock_odoo_employee_gateway.exists_by_id.assert_called_once_with(test_user_id)
