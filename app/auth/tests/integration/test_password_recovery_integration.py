...
from app.auth.api.dependencies import SMTPEmailService, BcryptPasswordService
...
def password_recovery_use_case_fixture(user_repository, email_service, password_service):
