...
5. Mostrar **resumen final** (no se debe mostrar ni id de tarea ni si está validada). Aquí sí se debe mostrar el nombre del proyecto y/o tarea original (bajo ningun punto de vista debes poner 'Proyecto 'X'' o 'Tarea 'X'').
